...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=0B6E4F&size=35&center=true&vCenter=true&width=1000&lines=Ol%C3%A1+%F0%9F%91%8B%2C+meu+nome+%C3%A9+Bernardo+Assad!;Desenvolvedor+FullStack;Bacharel+em+Sistemas+De+Informações+|+FIAP;Seja+bem-vindo!+:%29)](https://git.io/typing-svg)
...
Com 6 anos de experiência na área, formado em Sistemas de Informações na FIAP e atuando como AI Engineer Senior na Vivo, sendo Tech Lead na área. Na área de programação tenho trabalhos com Flutter, JavaScript, TypeScript, Next.js, Nest.js Python, PHP, Laravel e Kotlin além de outras ferramentas e metodologias. Meus estudos estão direcionados em Flutter, Python e Inteligência Artificial. Também tenho interesse na área de Engenharia de Dados.
